...
import type { FileRef, LogColour, LogLine, LogPart, LogPiece, LogTone } from "./PullRequest"
...
/**
 * The escape a runner writes before every colour it asks a terminal for.
 *
 * A control character in a pattern is usually somebody pasting one by accident,
 * which is what the rule is for. Here it is the thing being read: a log arrives
 * with these in it, and stripping them is how the colour becomes a `LogColour`
 * rather than three stray characters in front of a word.
 */

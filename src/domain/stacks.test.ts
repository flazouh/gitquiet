...
describe("finding the stacks among a set of pull requests", () => {
  test("one based on trunk stands on its own", () => {
    expect(outline(stacksIn([at("octo-repo", 1, "feature", "main")]))).toEqual([
      { head: "feature", above: [] }
    ])
  })
  ...
  test("one based on another's branch sits above it", () => {
    ...
    const stacks = stacksIn([at("octo-repo", 2, "second", "first"), at("octo-repo", 1, "first", "main")])
  ...
  test("a chain of three nests all the way down", () => {
    const stacks = stacksIn([
      at("octo-repo", 3, "third", "second"),
      at("octo-repo", 1, "first", "main"),
      at("octo-repo", 2, "second", "first")
    ])
  ...
  test("branches of the same name in different repositories never join", () => {
    ...
    const stacks = stacksIn([at("octo-repo", 1, "main", "trunk"), at("flowline", 2, "trunk", "main")])
  ...
  test("two roots come back as two stacks, in number order", () => {
    const stacks = stacksIn([
      at("octo-repo", 7, "seven", "main"),
      at("octo-repo", 3, "three", "main"),
      at("octo-repo", 8, "eight", "seven")
    ])
  ...
  test("siblings on the same parent come back in number order", () => {
    const stacks = stacksIn([
      at("octo-repo", 1, "first", "main"),
      at("octo-repo", 9, "late", "first"),
      at("octo-repo", 4, "early", "first")
    ])
  ...
  test("one whose base has no pull request of its own is a root", () => {
    ...
    // that outlived it.
    expect(outline(stacksIn([at("octo-repo", 2, "second", "first")]))).toEqual([
      { head: "second", above: [] }
    ])
  })
  ...
  test("a cycle neither hangs nor loses a member", () => {
    ...
    const stacks = stacksIn([at("octo-repo", 1, "first", "second"), at("octo-repo", 2, "second", "first")])
  ...
  test("every member appears exactly once, whatever the shape", () => {
    ...
    const members = [
      ...
      at("octo-repo", 2, "second", "first"),
      at("octo-repo", 3, "third", "second"),
      at("octo-repo", 4, "loop-a", "loop-b"),
      at("octo-repo", 5, "loop-b", "loop-a"),
      at("flowline", 6, "first", "main"),
      at("octo-repo", 7, "orphan", "long-gone")
    ]

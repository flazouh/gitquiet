...
import { foldedInto, pathIn, troubleIn } from "../github/logs"
...
export const LogPanel = ({
  ...
  return (
    <div className="mt-1 flex flex-col overflow-hidden rounded-md border border-line bg-canvas">
      <div className="flex shrink-0 items-center gap-2 border-b border-line bg-surface px-2 py-1">
        ...
        <input
          ...
          className="min-w-0 flex-1 rounded border border-line bg-canvas px-2 py-0.5 text-xs text-ink placeholder:text-ink-muted"
        />
...
const Group = ({
  ...
  <div>
    ...
    >
      ...
      {part.worst === "error" ? <XCircleFillIcon size={10} className="shrink-0 text-fail" /> : null}

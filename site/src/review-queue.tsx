    ...
    <Above>
      ...
      <div className="pb-16 pt-10 sm:pt-16">
        ...
        <p className="mt-6 max-w-xl text-pretty text-[17px] leading-relaxed text-ink/70">
          A queue you drain. Next review, not recency—on the GitHub session you already have.
        </p>
        <div className="mt-10">
          <AddToChrome big />
        </div>
    ...
    <main className={HELD}>
      <section id="job" className="border-t border-rule py-16">
        ...
        <p className="m-0 mt-4 max-w-2xl text-[16px] leading-relaxed text-muted">
          Searchers for a GitHub review queue want a queue they can drain—next review, not the
          newest request. One list of pull requests that need you is a different job:{" "}
          <Quietly at="/github-pr-inbox">a GitHub PR inbox, in the tab</Quietly>.
        </p>
      </section>

      <section className="border-t border-rule py-16">
        <h2 className="m-0 text-[22px] font-semibold tracking-[-0.02em]">A filter is not a queue</h2>
        <p className="m-0 mt-4 max-w-2xl text-[16px] leading-relaxed text-muted">
          GitHub&apos;s review-requested list is a filter. Newest first. Still a list you scan.
          GitQuiet is a queue on github.com—existing session, no extra login—writing back through
          GitHub&apos;s own routes. Not an AI reviewer.
        </p>
      </section>
      ...
      <section className="border-t border-rule py-16">
        ...
        <p className="m-0 mt-4 max-w-2xl text-[16px] leading-relaxed text-muted">
          ...
          session: To Review, Authored, Merged. A popup is not the page.
        </p>
        <p className="m-0 mt-4 max-w-2xl text-[16px] leading-relaxed text-muted">
        ...
        <p className="m-0 mt-4 max-w-2xl text-[16px] leading-relaxed text-muted">
          Attention Set is a PAT whose-turn popup—a near-miss, not its own URL. Graphite is stacked
          pull requests: a different job.
        </p>
      </section>

...
const Elsewhere = () => (
  <p className="m-0 text-[15px] leading-relaxed text-ink/65">
 ...
 * matches the Wafer-family bed without fighting it for attention.
 */
const ProductView = () => (
  <figure className="m-0">
    <img
      ...
      decoding="async"
      fetchPriority="high"
      className="block w-full rounded-2xl bg-paper ring-1 ring-ink/10"
...
/**
 * Home: Luminar-shaped hero card on the GitQuiet bed, copy left, PR shot right.
 *
 * One rounded full-viewport card with the living Bed mesh behind it. Light ink on
 * the pastel field. Below the fold stays short — jobs links and the shared footer.
 */
export const Page = () => (
  <div className="min-h-dvh antialiased" style={{ background: PAPER, color: "var(--color-ink, #1b1725)" }}>
        ...
        <div className="relative z-10 flex min-h-[calc(100svh-20px)] flex-1 flex-col sm:min-h-[calc(100svh-24px)]">
          ...
          >
            <div className="max-w-xl">
              ...
              <p className="mt-5 max-w-md text-pretty text-[17px] leading-relaxed text-ink/75 sm:text-lg">
